...
PythonName = "20250220-Tde-Analysis"
print("######################################## ")
print("20250220-Tde-Analysis.py: START")
...
if Active:
    ...
    if Method == "Log":
        ...
        DirectionList = ["dir_-1_1_0", "dir_-1_1_1", "dir_-1_1_2", "dir_0_0_1", "dir_0_1_0", "dir_0_1_1", "dir_0_3_1",
                         "dir_1_2_0", "dir_1_2_1", "dir_1_2_2"]
        ...
        Tde = pd.read_csv("20250505-Collection.csv")
    ...
    print("***** Type Division")
    # print(Tde)
    TdeDist = Tde.drop(columns=['DefectWs'])
    ...
    TdeDistGroupedPotential = TdeDist.groupby(['Potential'])
    TdeDistGroupedPotentialDirection = TdeDist.groupby(['Potential', 'Direction', 'DirectionMb', 'Reparameterization', 'X', 'Y', 'Z', 'R', 'UnitX', 'UnitY', 'UnitZ', 'Theta', 'Phi', 'a1', 'a2', 'a3', 'h'])
    ...
    # TdeGroupedPotentialDirectionDescribe = TdeGroupedPotentialDirectionDescribe[['min', 'mean', 'std']]
    # print(TdeGroupedPotentialDirectionDescribe)
    # os.system("pause")

    TdeDistGroupedPotentialDirectionStd = TdeDistGroupedPotentialDirection.std(numeric_only=True).reset_index()
    TdeDistGroupedPotentialDirectionDescribe = TdeDistGroupedPotentialDirection["Energy"].describe().reset_index()
    ...
    TdeDist.to_csv(PythonName + "-TdeDist" + ".csv", index=False)
    TdeDistGroupedPotentialDirectionDescribe.to_csv(PythonName + "-" + "TdeDistGroupedPotentialDirectionDescribe.csv", sep=',', index=False)
    ...
    TdeDist = pd.read_csv(PythonName + "-TdeDist" + ".csv")
    TdeDistGroupedPotentialDirectionDescribe = pd.read_csv(PythonName + "-" + "TdeDistGroupedPotentialDirectionDescribe.csv")
...
TdeDistGroupedPotential = TdeDist.groupby(['Potential'])
TdeDistGroupedPotentialDirection = TdeDist.groupby(
    ['Potential', 'Direction', 'DirectionMb', 'Reparameterization', 'X', 'Y', 'Z', 'R', 'UnitX', 'UnitY', 'UnitZ',
     'Theta', 'Phi', 'a1', 'a2', 'a3', 'h'])
...
# <editor-fold desc="######################################## Finishing Report">
print("######################################## Finishing Report")
print("20431216-Analyzing.py: FINISH")
print("######################################## ")
# </editor-fold>
